import { createElementClass, createXPathClass, querySelectorAllHtml, getAttributeText } from "./dom.js";
import { transformExtensionScript } from "./meta.js";
...
export async function createExtensionRuntime(meta, script) {
  ...
  // Browser-safe substitute for node:vm — extensions come from the Miru repo.
  const runner = new Function(
    ...names,
    `${code}\n;return (typeof __MiruExtensionClass === "function" ? __MiruExtensionClass : globalThis.__MiruExtensionClass);`
  );
  const ExtClass = runner(...values);
